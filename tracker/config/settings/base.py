"""
Base settings for tracker project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (tracker/config/settings/base.py - 3 = tracker/)
APPS_DIR = ROOT_DIR.path('tracker')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'tracker.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Asadov Ahmed""", 'zoxon470@gmail.com'),
]
